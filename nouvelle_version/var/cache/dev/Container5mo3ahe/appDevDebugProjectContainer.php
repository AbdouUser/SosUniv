...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'appbundle\\controller\\soscontroller' => 'AppBundle\\Controller\\SOSController',
        ...
        $this->fileMap = [
            ...
            'AppBundle\\Controller\\SOSController' => 'getSOSControllerService.php',
            ...
            'service_locator.k59hlbf' => 'getServiceLocator_K59hlbfService.php',
            'service_locator.p2tjb5k' => 'getServiceLocator_P2tjb5kService.php',
            'service_locator.th.bbmp' => 'getServiceLocator_Th_BbmpService.php',
        ...
        $this->privates = [
            ...
            'service_locator.k59hlbf' => true,
            'service_locator.p2tjb5k' => true,
            'service_locator.th.bbmp' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5Rn-JHozoq', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+S7MiRXq76', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o4swrx5j9k', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DSupW0M04h', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JD6qsBCP+k', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f858269a2bb9079e2b425e771bce09fe2163e940'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f858269a2bb9079e2b425e771bce09fe2163e940');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => 3306,
            'database_name' => 'SOS_Diderot',
            'database_user' => 'moxa',
            'database_password' => '0000',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.smtp2go.com',
            'mailer_user' => 'mohaxoy98@gmail.com',
            'mailer_password' => 'Azerty@007',
            'secret' => 'f858269a2bb9079e2b425e771bce09fe2163e940',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'f858269a2bb9079e2b425e771bce09fe2163e940',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mohaxoy98@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Azerty@007',
